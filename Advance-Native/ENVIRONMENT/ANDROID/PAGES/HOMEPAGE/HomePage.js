...
import { ANDROIDMUSICFEED } from "./MusicFeed.js";
...
const ANDROIDHOMEPAGE=(DIV,ADVANCE)=>{
    ...
    const STORIESDIV=ADVANCE.STORIESDIV;
    ...
    //APP START FUNCTIONS
    ADD(HORIZONTALSCROLLINGDIV,STORIESDIV);

    ANDROIDMUSICFEED(DIV,ADVANCE,STORIESDIV);
